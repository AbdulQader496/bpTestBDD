...
public class HomePage {
    ...
    // -------- Helper for stale-proof text retrieval ----------
    ...
    public void clickSubmitButton() {
        ...
        // Wait for DOM refresh to prevent stale reference issues
        wait().until(ExpectedConditions.presenceOfElementLocated(BP_CATEGORY_RESULT));
    }

    // ------------- Stale-Proof getters ----------------

    public String getBPCategoryResult() {
        return safeGetText(BP_CATEGORY_RESULT);
    }

    public String getIdealBPCategoryText() {
        return safeGetText(IDEAL_BP_CATEGORY);
    }

    public String getPreHighBPCategoryText() {
        return safeGetText(PREHIGH_BP_CATEGORY);
    }

    public String getHighBPCategoryText() {
        return safeGetText(HIGH_BP_CATEGORY);
    }

    public String getLowBPCategoryText() {
        return safeGetText(LOW_BP_CATEGORY);
    }

    public String getFooterPrivacyPolicyText() {
        return safeGetText(FOOTER_PRIVACY_POLICY_LINK);
    }

    public String getFooterCopyrightText() {
        return safeGetText(FOOTER_COPYRIGHT);
    }

    public String getSystolicValueValidationText() {
        return safeGetText(SYSTOLIC_VALUE_VALIDATION);
    }

    public String getDiastolicValueValidationText() {
        return safeGetText(DIASTOLIC_VALUE_VALIDATION);
    }

    public String getValueGreaterValidationText() {
        return safeGetText(VALUE_GRETTER_VALIDATION);
    }
}
