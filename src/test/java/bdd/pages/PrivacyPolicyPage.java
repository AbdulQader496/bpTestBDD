...
public class PrivacyPolicyPage extends HomePage{
    ...
    public String verifyPrivacyPolicyPageTitle(String expectedTitle) {
         return driver.findElement(By.xpath(String.format(LocatorConstants.PRECISE_TEXT_XPATH, NAME))).getText();
    }
